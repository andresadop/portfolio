const i18n = {
  es: {
    ...
    'projects.1.alt': 'Captura de plataforma E-Commerce',
    'projects.1.title': 'Plataforma E-Commerce',
    'projects.1.desc': 'Tienda en línea con carrito, pago y filtros de productos, construida con React y Redux.',
    'projects.2.alt': 'Captura del dashboard del clima',
    'projects.2.title': 'App del Clima',
    'projects.2.desc': 'App meteorológica en tiempo real con geolocalización, pronóstico de 7 días y visuales animados.',
    'projects.3.alt': 'Captura del gestor de tareas',
    'projects.3.title': 'Gestor de Tareas',
    'projects.3.desc': 'App estilo Kanban con arrastrar y soltar, sincronización en tiempo real y colaboración en equipo.',
    'projects.4.alt': 'Captura del sitio Web Freelance',
    'projects.4.title': 'Web Freelance',
    'projects.4.desc': 'Sitio web moderno y responsivo para servicios freelance con diseño limpio y profesional.',
    'projects.5.alt': 'Captura del Asistente Virtual',
    'projects.5.title': 'Asistente Virtual',
    'projects.5.desc': 'Asistente virtual con servicios profesionales, chatbot, agenda y pagos integrados.',
    'projects.demo': 'Demo',
  ...
  en: {
    ...
    'projects.1.alt': 'E-Commerce Platform screenshot',
    'projects.1.title': 'E-Commerce Platform',
    'projects.1.desc': 'Full-featured online store with cart, checkout, and product filtering built with React and Redux.',
    'projects.2.alt': 'Weather Dashboard screenshot',
    'projects.2.title': 'Weather Dashboard',
    'projects.2.desc': 'Real-time weather app with geolocation, 7-day forecasts, and animated weather visuals.',
    'projects.3.alt': 'Task Manager screenshot',
    'projects.3.title': 'Task Manager',
    'projects.3.desc': 'Kanban-style productivity app with drag-and-drop, real-time sync, and team collaboration.',
    'projects.4.alt': 'Web Freelance site screenshot',
    'projects.4.title': 'Web Freelance',
    'projects.4.desc': 'Modern and responsive website for freelance services with clean professional design.',
    'projects.5.alt': 'Virtual Assistant screenshot',
    'projects.5.title': 'Virtual Assistant',
    'projects.5.desc': 'Virtual assistant with professional services, chatbot, scheduling and payments.',
    'projects.demo': 'Live',
    'projects.code': 'Code',
